...
%TODO: change layout, atribuitions, shorter text, refactor for story stelling, practice
...
\frametitle{Import\^{a}ncia destas Tend\^{e}ncias para o FOSS4G}
    ...
    Mais aplicacoes e mais quantidades de dados: maior comunidade%pressao no desenvolvimento
    \begin{itemize}
        ...
        \item<2->Etica e privacidade.%O software aberto garante que nao existam backdoors ou codigo malicioso
    \end{itemize}                      
